...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x38f2aa248b8FC6393592399ad00F16803C5e0C92;
...
contract INR is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x38f2aa248b8FC6393592399ad00F16803C5e0C92;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Indian National Rupee";
    string private _symbol = "INR";
